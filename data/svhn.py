...
def get_svhn_datasets(train_transform, test_transform, train_classes=range(6),
    ...
    train_dataset_whole = CustomSVHN(root=svhn_root,download=True, transform=train_transform, split='train')
    ...
    test_dataset_known = CustomSVHN(root=svhn_root,download=True, transform=test_transform, split='test')
    test_dataset_known = subsample_classes(test_dataset_known, include_classes=train_classes)

    # Get testset for unknown classes
    test_dataset_unknown = CustomSVHN(root=svhn_root,download=True, transform=test_transform, split='test')
