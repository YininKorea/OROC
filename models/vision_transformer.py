...
if __name__=="__main__":
    ...
    if arch == "vit_small" and patch_size == 16:
        url = "../checkpoints/dino_deitsmall16_pretrain.pth"
        model=vit_small(patch_size=patch_size,num_classes=0)
    elif arch == "vit_small" and patch_size == 8:
        url = "../checkpoints/dino_deitsmall8_300ep_pretrain.pth"  # model used for visualizations in our paper
        model=vit_small(patch_size=patch_size,num_classes=0)
    elif arch == "vit_base" and patch_size == 16:
        url = "../checkpoints/dino_vitbase16_pretrain.pth"
        model=vit_base(patch_size=patch_size,num_classes=0)
    elif arch == "vit_base" and patch_size == 8:
        url = "../checkpoints/dino_vitbase8_pretrain.pth"
        model=vit_base(patch_size=patch_size,num_classes=0)
