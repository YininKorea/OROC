...
class Net(nn.Module):
    def __init__(self,arch='vit_base',patch_size=16,image_size=(224,224),resume='./checkpoints/dino_vitbase16_pretrain.pth',num_mlp_decoder=4,num_slot=6,slot_dim=256,mlp_hidden_size=64,num_iteration=3,num_classes=20,freezen_object=True):
        super().__init__()
...
if __name__=="__main__":
    ...
    slots,class_pred, slots_mask,feat_loss,matching_loss=model(input)
